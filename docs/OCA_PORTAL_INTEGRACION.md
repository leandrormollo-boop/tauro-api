...
Publicar el código y activar OCA son pasos diferentes. Esta rama no se desplegó. Antes de activar, confirmar con OCA la operativa productiva, centro, seguro y condiciones; cargar secretos/flags y una tarifa explícita por cliente. La evidencia real de QA valida PaP sin seguro, no acredita la operativa productiva asegurada.
