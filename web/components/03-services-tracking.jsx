...
const SERVICES = [
  {
    ...
    desc: "Recibí pedidos de Shopify o cargá tus envíos manualmente.",
  ...
  },
  {
    ...
    desc: "Clientes, productos, envíos y documentos en una sola cuenta.",
  ...
  },
  {
    ...
    desc: "Compará las opciones disponibles para tu ruta antes de crear el envío.",
  ...
  },
  {
    ...
    desc: "Emití guías y programá retiros según los servicios habilitados para tu cuenta.",
  ...
  },
  {
    ...
    desc: "Consultá guías, seguimiento, facturas y saldo desde el portal.",
  ...
  },
  {
    ...
    desc: "Usá una misma operación para tus envíos internacionales y sumá la opción nacional cuando se habiliten OCA y Andreani.",
    bullets: ["Operación internacional habilitada", "Nacional en preparación", "Configuración por cliente"],
